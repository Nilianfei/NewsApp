 ...
 */
public class List_Fragment_1 extends Fragment {

    private List<News> newsList =new ArrayList<>();
    private static List_Fragment_1 instance=null;
    public static List_Fragment_1 newInstance() {
        if(instance==null){
            instance=new List_Fragment_1();
        }
        return instance;
    }
    public List_Fragment_1() {
